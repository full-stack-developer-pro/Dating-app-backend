...
module.exports=(app,validator)=>{    
    ...
    app.get("/api/admin/getAboutAs/:_id",adminCtr.getAbout)
    app.post("/api/admin/contactAs/:_id",validator.body(adminValidator.contact),adminCtr.addContact)
    app.get("/api/admin/getcontactAs/:_id",adminCtr.getContact)
